# I did not write this. All credit for this script goes to @tashapiro
# https://github.com/tashapiro/tanya-data-viz/blob/main/spotify-artists/scripts/social-caption.R
